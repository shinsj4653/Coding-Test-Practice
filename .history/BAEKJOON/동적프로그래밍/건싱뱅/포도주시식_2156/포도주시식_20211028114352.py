...
for i in range(n // 3 + 1):
    if i == 0:
        a = wineList[i] + wineList[i + 1]
        b = wineList[i] + wineList[i + 2]
        c = wineList[i + 1] + wineList[i + 2]
        if max(a, b, c) == wineList[i] + wineList[i + 1]:
            selectedWine.append(i, i + 1)

        elif max(a, b, c) == wineList[i] + wineList[i + 2]:
            selectedWine.append(i, i + 2)
        else:
            selectedWine.append(i + 1, i + 2)
